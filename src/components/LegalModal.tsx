            ...
            <div className="space-y-4">
              <div className="p-3.5 bg-amber-50 rounded-xl border border-amber-200 text-amber-950 space-y-1">
                ...
                <p className="text-xs leading-relaxed">
                  نظام حاسوبي وتحليلي دقيق لتشفير وفك تشفير النصوص العربية استناداً إلى مصفوفة الطبقات السبع المتناظرة والربط مع المعجم القرآني الشريف والمعجم اللغوي العربي.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="border border-stone-200 p-3.5 rounded-xl space-y-1.5">
                  <h5 className="font-bold text-stone-900 flex items-center gap-1.5">
                    ...
                    ٣. قسم جدول الطبقات السبع التفاعلي (قابل للتعديل والسحب والإفلات):
                  </h5>
                  <p className="text-xs text-stone-600 leading-relaxed">
                    يعرض المصفوفة الكاملة للطبقات السبع، مع إمكانية سحب الأحرف بالماوس لتبديل أماكنها، أو النقر السريع للتبديل بين أي خانتين، وإمكانية تفريغ الجدول للبدء من الصفر وتعبئته من بنك الأحرف الـ 28 أو تطبيق قوالب جاهزة، مع تعديل مفاتيح التشفير، وحفظ التعديلات تلقائياً لتعمل كافة أقسام التشفير وفك التشفير وفق الجدول المخصص.
                  </p>
                </div>
